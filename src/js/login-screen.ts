...
function removeActive(element: HTMLElement): void {
  element.classList.remove('active');
}

// you can provide an explicit this parameter in TypeScript. this parameters are fake parameters that come first in the parameter list of a function:
// TODO: rename this
function checkActive(this: HTMLElement): void {
